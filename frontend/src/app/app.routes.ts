...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () => import('./features/specialities/specialities.component').then((m) => m.SpecialitiesComponent),
  },
  {
    path: 'addresses',
  ...
  },
  {
    ...
    loadComponent: () => import('./features/administrative-divisions/administrative-divisions.component').then((m) => m.AdministrativeDivisionsComponent),
  },
  {
    path: 'not-found',
    loadComponent: () =>

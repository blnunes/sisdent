...
public record PatientAddressMutationInput(
        @NotBlank String street, String district, @NotBlank String city, String additionalInfo, String block,
        @NotBlank @Size(max = 20) String postalCode,
        @Valid AdministrativeDivisionMutationInput administrativeDivision,

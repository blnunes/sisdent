...
class Phase5ClinicalRecordsIntegrationTests {
 ...
 @Test void preservesFinalEncounterAndVoidReplaceOdontogramHistory() throws Exception {
  ...
  Account manager=accounts.save(new Account(persons.save(new Person("Clinical manager")),null,"clinical-manager@example.com",encoder.encode("phase5-password"),false,false)); memberships.save(new Membership(manager,organization,clinic,MembershipRole.CLINICAL_MANAGER));

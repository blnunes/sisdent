    ...
    void doesNotPublishRetiredSpecialityOperations() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.paths['/api/organizations/{organizationId}/patients/{patientId}'].put")
                        .doesNotExist())
                .andExpect(jsonPath("$.paths['/api/organizations/{organizationId}/patients'].get").doesNotExist())
                .andExpect(jsonPath("$.paths['/api/organizations/{organizationId}/patients'].post").doesNotExist())
                .andExpect(jsonPath("$.paths['/api/organizations/{organizationId}/patients/{patientId}'].delete").doesNotExist())
